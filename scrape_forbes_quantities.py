...
FINAL_OUTPUT_DIR = "source_reports/forbes_tea_quantities"
...
def parse_quantities_from_ocr_final(ocr_text):
    ...
    for line in lines:
        ...
        if match:
            ...
            # --- FINAL POLISH: Standardize the date format ---
            try:
...
def scrape_forbes_quantities_ocr():
    ...
    screenshot and using the definitive OCR text parser.
    """
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            screenshot_path = os.path.join(FINAL_OUTPUT_DIR, "temp_quantities_screenshot.png")
            ...
            output_filename = f"ForbesTea_WeeklyQuantities_Final_{date_str}.json"
