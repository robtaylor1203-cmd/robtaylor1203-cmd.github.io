...
def process_jthomas_synopsis():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # Select the latest sale
            page.select_option(sale_dropdown_selector, index=1)
            
            # Click refresh and wait for new page
    ...
    if downloaded_pdf_path and sale_number:
        ...
        try:
            ...
            output_data = {
                "report_title": f"J Thomas Market Synopsis - Sale {sale_number}",
                "source_pdf": downloaded_pdf_path.name,
                "raw_text": full_text
            }

            # --- Standardized Saving Mechanism ---
            file_prefix = "JT_synopsis_parsed"
